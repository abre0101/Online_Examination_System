...
<title>SUOES Schedule page</title>
...
'July', 'MWUgust', 'September', 'October', 'November', 'December'
	              ...
	              <table width="90%" border="5" bordercolor="#85A157" >
                    <tr>
                      ...
                      <th bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>Date</strong></div></th>
                       <th bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>Start Time</strong></div></th>
                       <th bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>End Time</strong></div></th>
...
{
$Id=$row['schedule_id'];
$Exam_Type=$row['exam_name'];
$Sem=$row['semister'];
$Course=$row['course_name'];
$Date=$row['exam_date'];
$Start_Time=$row['exam_time'];
$End_Time=$row['exam_time'];


?>
                    <tr>
                      <td class="style13"><div align="left" class="style9 style6"><strong><?php echo $Id;?></strong></div></td>
                      <td class="style13"><div align="left" class="style9 style6"><strong><?php echo$Exam_Type;?></strong></div></td>
                      ...
                      <td class="style13"><div align="left" class="style9 style6"><strong><?php echo $Start_Time;?></strong></div></td>
                      <td class="style13"><div align="left" class="style9 style6"><strong><?php echo $End_Time;?></strong></div></td>
