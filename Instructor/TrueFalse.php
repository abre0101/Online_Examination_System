...
<title>SU OES-Instructor Question Management</title>
...
<div id="container">
  ...
  <div id="content">
    ...
    <div id="left">
			...
			<h3 color='red'>Hi <?php // echo $_SESSION['Name'];?> Welcome to Manage  Question</h3>
			
	        <div id="TabbedPanels1" class="TabbedPanels">
	          <ul class="TabbedPanelsTabGroup">
	            <li class="TabbedPanelsTab style1" tabindex="0">Add True/False</li>
...
$sql = "SELECT distinct truefalse_question.question_id,truefalse_question.exam_id, truefalse_question.semester, truefalse_question.course_name, truefalse_question.question, truefalse_question.Answer1, truefalse_question.Answer2, truefalse_question.Answer, course.course_name, exam_category.exam_name;
FROM truefalse_question, exam_category, course
WHERE truefalse_question.exam_id=exam_category.exam_id AND truefalse_question.course_name=course.course_name";
$sql = "SELECT * FROM truefalse_question ";
// Execute query
