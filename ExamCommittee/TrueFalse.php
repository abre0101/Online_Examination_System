...
$sql = "SELECT distinct truefalse_question.question_id,truefalse_question.exam_id, truefalse_question.course_name,truefalse_question.semister, truefalse_question.question, truefalse_question.Answer1, truefalse_question.Answer2, truefalse_question.Answer, course.course_name, exam_category.exam_name *FROM truefalse_question, exam_category, course
...
?>
                <table width="100%" height="184" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td><a href="TrueFalse.php?QueId=<?php echo $Id;?>"><strong>Submit</strong></a></td>
                    </tr>
                    <tr>
                      <td colspan="2"><hr/></td>
                    </tr> 
